...
public class ApplicationExampleTest {
    ...
    public void beforeEach() {
        ...
        student.setEmailAddress("myEmail@address.com");
    ...
    public void checkNullForStudentGrades() {
        assertNotNull(studentGrades.checkNull(student.getStudentGrades().getMathGradeResults()), "Objcet should not be null");
    }
    ...
    public void createStudentWithoutGradeInit() {
        ...
        studentTwo.setEmailAddress("myMail@address.com");
